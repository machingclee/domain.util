        ...
        <div
            ...
            style={{
                ...
                backgroundColor: isSub
                    ? "rgba(135,185,250,0.08)"
                    : "rgba(135,185,250,0.2)",
                position: "relative",
                // Let pointer events fall through to React Flow's node wrapper
                // so child nodes receive clicks first.
                pointerEvents: "none",
            }}
        >
            <span
                style={{
                    ...
                    alignItems: "center",
                    gap: "8px",
                    // Re-enable pointer events on the badge so it remains
                    // clickable and serves as a drag handle for the group.
                    pointerEvents: "auto",
                }}
            >
                {isSub && (
